...
function fitBig(){
	...
	if ($('#big-img > img').width() > $(window).width() - 100) {
        $('#big-img > img').width($(window).width() - 200);
        $('#big-img > img').height('auto');
    }
    if ($('#big-img > img').height() > $(window).height() - 100) {
        $('#big-img > img').height($(window).height() - 50);
        $('#big-img > img').width('auto');
    }
    $('#big-img > h1').height($(window).height());
	$('#big-img > img').css('top', $(window).height() / 2 - $('#big-img').children('img').height() / 2);
