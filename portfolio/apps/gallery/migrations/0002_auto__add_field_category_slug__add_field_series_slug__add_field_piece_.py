...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_category', 'slug', self.gf('django.db.models.fields.SlugField')(default='bad-slug', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Series.slug'
        db.add_column('gallery_series', 'slug', self.gf('django.db.models.fields.SlugField')(default='bad-slug', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Piece.slug'
        db.add_column('gallery_piece', 'slug', self.gf('django.db.models.fields.SlugField')(default='bad-slug', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.slug'
        db.delete_column('gallery_category', 'slug')

        # Deleting field 'Series.slug'
        db.delete_column('gallery_series', 'slug')

        # Deleting field 'Piece.slug'
        db.delete_column('gallery_piece', 'slug')
